...
def load_malicious_ips(csv_file):
    ...
    print(f"Loaded malicious IPs: {malicious_ips}")
...
def select_best_model(evaluation_csv):
    ...
    print(f"DDQN Avg Reward: {ddqn_avg_reward}, Max Reward: {ddqn_max_reward}")
    print(f"SARSA Avg Reward: {sarsa_avg_reward}, Max Reward: {sarsa_max_reward}")
    print(f"A2C Avg Reward: {a2c_avg_reward}, Max Reward: {a2c_max_reward}")

    # Select model based on the highest max reward
    if ddqn_avg_reward >= sarsa_avg_reward and ddqn_avg_reward >= a2c_avg_reward:
        best_model_name = "ddqn"
    elif sarsa_avg_reward >= ddqn_avg_reward and sarsa_avg_reward >= a2c_avg_reward:
